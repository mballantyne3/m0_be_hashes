...
states.each do |state, abbreviation|
  p "I visited #{state} #{abbreviation} over the summer last year and it was great!"
end
#
#
...
birthdays.each do |name, birthday|
  p "My friend #{name} is having their party on #{birthday}"
end
#
#
...
login_statuses.each do |friend, is_online|
  p friend if is_online
end
#
#
